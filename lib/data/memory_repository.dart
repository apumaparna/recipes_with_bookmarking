...
class MemoryRepository extends Repository with ChangeNotifier {
  ...
  int insertRecipe(Recipe recipe) {
    ...
    notifyListeners();
    // Return the ID of the new recipe. Since you don’t need it,
  ...
  void deleteRecipeIngredients(int recipeId) {
    // Go through all ingredients and look for ingredients that have the
  ...
  // Since this is a memory repository, you don’t need to do anything to
  // initialize and close but you need to implement these methods.
  @override
  Future init() {
