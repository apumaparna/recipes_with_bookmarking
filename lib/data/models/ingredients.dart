...
// The Ingredient class extends Equatable, to provide support for
// equality checks.
class Ingredient extends Equatable {
  // Add the properties an ingredient needs.
  // You don’t declare recipeId or id as final so you can change
  // those values later.
  int? id;
  int? recipeId;
  final String? name;
  ...
  // Equatable uses the props value.
  // Here, you provide the fields you want to use to check
  // for equality.
  @override
